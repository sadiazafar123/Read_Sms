...
class ThreadAdapter(private val threadsList: ArrayList<ArrayList<UserInfo>>, var mListener:onItemSpecificUser) :RecyclerView.Adapter<ThreadAdapter.MyViewHolder>(){
